package com.gurugan.infra.modules.chat;
...
public class Chat {
	...
	private Integer MBseq;       //유저 시퀀스
	private String MBname;   //유저 이름 or 닉네임
	...
	public Integer getMBseq() {
		return MBseq;
	}
	public void setMBseq(Integer mBseq) {
		MBseq = mBseq;
	}
