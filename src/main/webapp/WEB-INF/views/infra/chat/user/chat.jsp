...
<body> 
	                            	...
	                            	<c:forEach items="${list }" var="list" varStatus="status">
		                                    ...
		                                    <div class="d-flex bd-highlight">
		                                        ...
		                                        <div class="chat_product_info">
		                                            ...
		                                            <span class="status"><c:out value="${list.MBname }"/></span>
					                                 			<p>TEST TEXT FIELD</p>
		                                        </div>
		                                    </div>
		                                </li>
  ...
  //Firebase 프로젝트에서 추출한 정보 입력
	const firebaseConfig = {
  		apiKey: "AIzaSyB-r06wJrq3l1KV8ZQ3TrSDo5KHwN_VO-0",
    	authDomain: "dolphin-chat-b8d4c.firebaseapp.com",
    	databaseURL: "https://dolphin-chat-b8d4c-default-rtdb.firebaseio.com",
    	projectId: "dolphin-chat-b8d4c",
    	storageBucket: "dolphin-chat-b8d4c.appspot.com",
    	messagingSenderId: "252459236807",
		appId: "1:252459236807:web:b0f985a585e4ac1a04ade2"
	};		
	// Initialize Firebase
